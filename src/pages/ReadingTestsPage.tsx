...
import { ArrowLeft, BookText, Clock, BookOpen, ChevronDown, ChevronRight, Play, CheckCircle2, Award } from 'lucide-react';
...
export function ReadingTestsPage() {
  ...
  return (
    <div className="min-h-screen bg-white">
      {/* Hero Section */}
      <section className="px-6 py-12 md:py-16 bg-gradient-to-br from-green-50 to-white">
        <div className="max-w-5xl mx-auto">
          ...
          >
            <div className="inline-flex items-center justify-center w-20 h-20 bg-green-100 rounded-2xl mb-6">
              <BookText className="w-10 h-10 text-green-600" />
            </div>
          ...
          >
            ...
            <div className="flex items-center gap-3 px-6 py-3 bg-white rounded-xl shadow-sm">
              ...
              <div>
                <div className="font-semibold text-gray-900">60 mins</div>
                  ...
                  >
                    <div className="flex items-center gap-4">
                      ...
                      <div className="relative flex-shrink-0">
                        <div className="w-14 h-16 bg-gradient-to-br from-green-500 to-green-600 rounded-lg shadow-md flex items-center justify-center">
                        ...
                        <div className="absolute -bottom-1 -right-1 w-6 h-6 bg-green-100 rounded-full flex items-center justify-center">
                          <BookText className="w-3 h-3 text-green-600" />
                        </div>
                      </div>
                          ...
                          <div className="space-y-3">
                            {book.tests.map((test, testIndex) => {
                              ...
                              return (
                                ...
                                >
                                  <button
                                    className="w-full group bg-gray-50 hover:bg-green-50 border-2 border-gray-100 hover:border-green-500 rounded-xl p-4 transition-all"
                                  >
                                      ...
                                      <div className="flex items-center gap-4">
                                        ...
                                        <div className={`w-12 h-12 rounded-lg flex items-center justify-center flex-shrink-0 transition-colors ${
                                          isCompleted 
                                            ...
                                            : 'bg-white border-2 border-gray-200 text-gray-600 group-hover:border-green-500 group-hover:text-green-600'
                                        }`}>
                                          {isCompleted ? (
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-gray-700 leading-relaxed mb-4">
                  Each reading test contains 3 passages with 40 questions total. The test takes 60 minutes. Academic and General Training tests have different passage types.
                </p>
                <ul className="space-y-2 text-gray-700">
                  <li className="flex items-start gap-2">
                    <div className="w-1.5 h-1.5 bg-blue-500 rounded-full mt-2 flex-shrink-0" />
                    <span><strong>Passage 1:</strong> Generally the easiest, from books, magazines, or newspapers</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="w-1.5 h-1.5 bg-blue-500 rounded-full mt-2 flex-shrink-0" />
                    <span><strong>Passage 2:</strong> Moderate difficulty with work-related or general interest topics</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="w-1.5 h-1.5 bg-blue-500 rounded-full mt-2 flex-shrink-0" />
                    <span><strong>Passage 3:</strong> Most difficult, dealing with complex ideas and vocabulary</span>
                  </li>
                </ul>
              </div>
            </div>
