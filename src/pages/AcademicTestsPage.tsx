import { GraduationCap, Clock, BookOpen, ChevronLeft, ChevronRight } from 'lucide-react';
...
export function AcademicTestsPage() {
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-xl text-gray-600 mb-8 leading-relaxed">
                Choose from Cambridge IELTS books 11-19. Each book contains 4 full authentic Academic practice tests.
              </p>
            ...
            >
              <svg viewBox="0 0 120 120" fill="none" className="w-full max-w-lg mx-auto drop-shadow-2xl">
                ...
                >
                  <rect x="40" y="25" width="40" height="6" rx="2" fill="#1F2937" />
                  <path d="M30 30 L60 38 L90 30 L60 22 Z" fill="#1F2937" />
                  <rect x="58" y="38" width="4" height="15" fill="#F97316" />
        ...
        <div className="page-container">
          ...
          >
            <div className="flex items-start gap-4">
              ...
              <div>
                <h3 className="text-xl font-bold text-gray-900 mb-2">About IELTS Academic Tests</h3>
                <p className="text-gray-700 leading-relaxed mb-4">
                  Each full academic test spans roughly 2 hours and 45 minutes, testing your Listening, Reading, and Writing skills sequentially, plus Speaking.
                </p>
                <ul className="space-y-2 text-gray-700">
                  ...
                  <li className="flex items-start gap-2">
                    <div className="w-1.5 h-1.5 bg-blue-500 rounded-full mt-2 flex-shrink-0" />
                    <span><strong>Reading (60 mins):</strong> 3 long academic texts, 40 questions</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="w-1.5 h-1.5 bg-blue-500 rounded-full mt-2 flex-shrink-0" />
                    <span><strong>Writing (60 mins):</strong> 1 data interpretation task, 1 essay</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="w-1.5 h-1.5 bg-blue-500 rounded-full mt-2 flex-shrink-0" />
