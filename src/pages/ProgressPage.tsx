...
import { BookOpen, Clock, Trophy, Target, ChevronLeft, ChevronRight, Headphones, BookText } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-5xl mx-auto px-4 py-10">
        ...
        {/* Skill Breakdown */}
        {stats && (stats.listening.attempts > 0 || stats.reading.attempts > 0) && (
        ...
        <div className="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden">
          ...
          {historyLoading ? (
            ...
            <div>
              {/* Table Header */}
              <div className="hidden md:grid grid-cols-12 gap-4 px-5 py-3 bg-gray-50 text-xs font-semibold text-gray-500 uppercase tracking-wide">
                ...
                >
                  ...
                  <div className="col-span-12 md:col-span-4 flex items-center gap-3">
                    <div className={`w-8 h-8 rounded-lg flex items-center justify-center flex-shrink-0 ${
                      attempt.skill === 'listening' ? 'bg-orange-50' : 'bg-green-50'
                    }`}>
