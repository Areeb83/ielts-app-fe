...
import { ArrowLeft, PenTool, Clock, BookOpen, ChevronDown, ChevronRight, Play, CheckCircle2, Award } from 'lucide-react';
...
export function WritingTestsPage() {
  ...
  return (
    <div className="min-h-screen bg-white">
      {/* Hero Section */}
      <section className="px-6 py-12 md:py-16 bg-gradient-to-br from-purple-50 to-white">
                  ...
                  >
                    <div className="flex items-center gap-4">
                      ...
                      <div className="relative flex-shrink-0">
                        <div className="w-14 h-16 bg-gradient-to-br from-purple-500 to-purple-600 rounded-lg shadow-md flex items-center justify-center">
                          ...
                          <div className="space-y-3">
                            {book.tests.map((test, testIndex) => {
                              ...
                              return (
                                ...
                                >
                                  <button
                                    className="w-full group bg-gray-50 hover:bg-purple-50 border-2 border-gray-100 hover:border-purple-500 rounded-xl p-4 transition-all"
                                  >
                                      ...
                                      <div className="flex items-center gap-4">
                                        ...
                                        <div className={`w-12 h-12 rounded-lg flex items-center justify-center flex-shrink-0 transition-colors ${
                                          isCompleted 
                                            ...
                                            : 'bg-white border-2 border-gray-200 text-gray-600 group-hover:border-purple-500 group-hover:text-purple-600'
                                        }`}>
                                          {isCompleted ? (
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-gray-700 leading-relaxed mb-4">
                  Each writing test consists of 2 tasks that must be completed in 60 minutes. Both tasks are mandatory and your responses will be assessed on multiple criteria.
                </p>
                <ul className="space-y-2 text-gray-700">
                  <li className="flex items-start gap-2">
                    <div className="w-1.5 h-1.5 bg-blue-500 rounded-full mt-2 flex-shrink-0" />
                    <span><strong>Task 1 (20 mins):</strong> Describe visual information (graph, chart, diagram) or write a letter (General Training)</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="w-1.5 h-1.5 bg-blue-500 rounded-full mt-2 flex-shrink-0" />
                    <span><strong>Task 2 (40 mins):</strong> Write an essay in response to a point of view, argument, or problem</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="w-1.5 h-1.5 bg-blue-500 rounded-full mt-2 flex-shrink-0" />
                    <span><strong>Assessment:</strong> Task Achievement, Coherence & Cohesion, Lexical Resource, Grammatical Range & Accuracy</span>
                  </li>
                </ul>
              </div>
            </div>
